...
import { Heart } from '../../icons/orderStatus';
...
export default function MobileNav() {
  ...
  return (
    <>
      <div className="bg-grey-900 px-4 py-6 flex justify-between">
        <a href="">
          <figure>
        ...
        >
          {isHamOpen ? <HamburgerIcon /> : <CloseMenu />}
        </figure>
      </div>
      {isHamOpen ? (
        <div className="bg-primary-500 p-4 flex flex-col gap-[195px]">
          <div className="user-menu flex gap-4 flex-col">
            ...
            <div className="search-bar flex border gap-2 border-white items-center min-w-[unset] w-full max-h-12 px-4 py-3 xl:min-w-[453px] ">
              ...
              <input
                ...
                className="border-none w-full placeholder:italic placeholder:text-base placeholder:font-bold placeholder:text-white bg-transparent "
              />
            </div>
            ...
            <div className="">
              <ul className="flex flex-col gap-4">
                {navigations.map((navigation) => (
                  <li
                    key={navigation.id}
                    className="italic uppercase font-bold text-base text-white hover:text-secondary-500 "
                  >
